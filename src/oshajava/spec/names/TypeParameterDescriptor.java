...
public class TypeParameterDescriptor extends TypeDescriptor {
	...
	public TypeParameterDescriptor(String varName, List<TypeDescriptor> extendees) {
		this.varName = varName;
		this.extendees = extendees;
	}
	public TypeParameterDescriptor(TypeParameterElement e, Elements util) {
